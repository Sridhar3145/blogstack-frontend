   ...
   <nav className='bg-blue-400 rounded-lg'>
    <div className='flex justify-between items-center md:px-12 px-3'>
     ...
     <div className='md:flex gap-10 hidden'>
      ...
      {!username ? (
       <Link to="/login" className='hover:scale-110 transition-all text-white'>
        Login
       </Link>
      ) : (
       <button
   ...
   {toggleMenu && (
    <div className='absolute top-16 mt-1 bg-blue-400 rounded-lg z-30 border border-white'>
     <div className='flex flex-col text-center md:hidden gap-6 p-6'>
      {isAdmin && (
       <Link to="/pending" className='hover:scale-110 transition-all text-white' onClick={() => setToggleMenu(false)}>
        Pending Approval
       </Link>
      )}
      ...
      {isLogin && (
       <Link to="/myblogs" className='hover:scale-110 transition-all text-white' onClick={() => setToggleMenu(false)}>
        My Blogs
       </Link>
      )}
